<%@ Control Language="C#" CodeBehind="GridViewPager.ascx.cs" Inherits="RmsAuto.Store.Adm.GridViewPager" %>
...
<div class="pager">
    <span class="results1">
        ...
        ID="ImageButtonNext" runat="server" ImageUrl="Images/PgNext.gif" Width="5" 
        Height="9" CommandName="Page" CommandArgument="Next" />
        &nbsp;
    ...
    <span class="results2">
        <asp:Label ID="LabelRows" runat="server" Text="Строк на странице:" AssociatedControlID="DropDownListPageSize" />
