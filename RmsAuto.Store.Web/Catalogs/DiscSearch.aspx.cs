...
namespace RmsAuto.Store.Web.Store
{
	...
	public partial class DiscSearch : LocalizablePage
    {
        ...
        {
            Quantity.Text = DiscSearchControl.CurrentSearchCount.ToString();
            QuantityWarningText.Visible = DiscSearchControl.ExceedMaxresult;
            QuantityText.Visible = !DiscSearchControl.ExceedMaxresult;
            Quantity.Visible = !DiscSearchControl.ExceedMaxresult;
            Elements_Count.Visible = DiscSearchControl.CurrentSearchCount > 0;
            info_block.Visible = DiscSearchControl.CurrentSearchCount > 0;
        }
    }
}
