...
namespace RmsAuto.Store.Web.Manager
{
    ...
    public class UseWorkSearch : IHttpHandler, IRequiresSessionState
    {
...
from [SQLWEBCLUSTER\SQL_WEB].ex_rmsauto_store/*ex_rmsauto_crosses*/.dbo.SpareParts /* 'Наши' остатки */ as p /*with (NoLock)*/
	join [SQLWEBCLUSTER\SQL_WEB].ex_rmsauto_store/*ex_rmsauto_crosses*/.dbo.PricingMatrixEntries /* 'Наши' наценки */ e on e.PricingMatrixEntryID = ( select top 1 
                                                              PricingMatrixEntryID 
                                                            from ( select 
                                                                     PricingMatrixEntryID, 10 as OrderBy
                                                                   from [SQLWEBCLUSTER\SQL_WEB].ex_rmsauto_store/*ex_rmsauto_crosses*/.dbo.PricingMatrixEntries e1 /*  наценки */
                                                                   where e1.SupplierID = p.SupplierID 
                                                                     ...
                                                                     and e1.RgCode is null
		                                                               ...
		                                                               from [SQLWEBCLUSTER\SQL_WEB].ex_rmsauto_store/*ex_rmsauto_crosses*/.dbo.PricingMatrixEntries e2 /*  наценки */
		                                                               ...
		                                                               from [SQLWEBCLUSTER\SQL_WEB].ex_rmsauto_store/*ex_rmsauto_crosses*/.dbo.PricingMatrixEntries e3 /* наценки */
		                                                               ...
		                                                               from [SQLWEBCLUSTER\SQL_WEB].ex_rmsauto_store/*ex_rmsauto_crosses*/.dbo.PricingMatrixEntries e4 /*  наценки */
		                                                               ...
		                                                               from [SQLWEBCLUSTER\SQL_WEB].ex_rmsauto_store/*ex_rmsauto_crosses*/.dbo.PricingMatrixEntries e5 /* наценки */
