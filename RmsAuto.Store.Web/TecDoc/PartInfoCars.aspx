<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartInfoCars.aspx.cs" Inherits="RmsAuto.Store.Web.PartInfoCars" %>
<%@ Register Src="Controls/TecdocPartInfo.ascx" TagName="TecdocPartInfo" TagPrefix="uc1" %>
<%@ Register Src="Controls/TecdocPartAppliedCarsInfo.ascx" TagName="TecdocPartAppliedCarsInfo" TagPrefix="uc1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title><%=global::Resources.Texts.ApplicabilityOnCars %></title>
