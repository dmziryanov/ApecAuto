<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TecDocModelDetails.aspx.cs"
	Inherits="RmsAuto.Store.Web.TecDoc.TecDocModelDetails" MasterPageFile="~/PageTwoColumnsNEW.Master" %>
...
<%@ Register src="Controls/TecDocModifications.ascx" tagname="TecDocModifications" tagprefix="uc3" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="_textContentPlaceHolder">
	...
	<div>
		<uc3:TecDocModifications ID="_tecDocModifications" runat="server" />
	</div>
</asp:Content>
