<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TecDocSearchTreeNodeDetails.aspx.cs"
	Inherits="RmsAuto.Store.Web.TecDoc.TecDocSearchTreeNodeDetails" MasterPageFile="~/PageTwoColumnsNEW.Master" %>
...
<%@ Register src="Controls/TecDocParts.ascx" tagname="TecDocParts" tagprefix="uc3" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="_textContentPlaceHolder">
	...
	<div>
		<uc3:TecDocParts ID="_tecDocParts" runat="server" />
	</div>
</asp:Content>
