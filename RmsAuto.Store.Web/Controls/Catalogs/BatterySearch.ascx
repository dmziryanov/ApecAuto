<%@ Control  Language="C#" AutoEventWireup="true" CodeBehind="BatterySearch.ascx.cs" Inherits="RmsAuto.Store.Web.Controls.BatterySearch" %>
...
<tr >
<td class="cont">
    <span>емкость:</span><br />
    <span>полярность:</span><br />
    <span>клеммы:</span><br />
    <span>габариты:</span><br />
    <%--<span>срок поставки:</span>--%>
</td>
<td class="cont2" colspan="2">
    <span><%#Server.HtmlEncode(Convert.ToString(Eval("Capacity")))%></span><br />
    <span><%#Server.HtmlEncode(Convert.ToString(Eval("Polarity")))%></span><br />
    <span><%#Server.HtmlEncode(Convert.ToString(Eval("Cleat")))%></span><br />
    <span><%#Server.HtmlEncode(Convert.ToString(Eval("Size")))%></span><br />
    <%--<span><%# ((SparePart)((Battery)Container.DataItem).SparePart).DisplayDeliveryDaysMin%>-<%# ((SparePart)((Battery)Container.DataItem).SparePart).DisplayDeliveryDaysMax%></span>--%>
</td>
</tr>
<tr class="pricerow">
    <td>
