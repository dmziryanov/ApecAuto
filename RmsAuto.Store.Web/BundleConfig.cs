    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/css/css").Include(
                      ...
                      "~/css/animate.css",
                      "~/css/style.css", "~/css/style_inspinia.css"));
            ...
            bundles.Add(new StyleBundle("~/css/plugins/blueimp/css/").Include(
            ...
            // iCheck css styles
            bundles.Add(new StyleBundle("~/css/plugins/iCheck/iCheckStyles").Include(
            ...
            bundles.Add(new StyleBundle("~/css/plugins/dataTables/dataTablesStyles").Include(
            ...
            // jqGrid styles
            bundles.Add(new StyleBundle("~/css/plugins/jqGrid/jqGridStyles").Include(
            ...
            // ionRange styles
            bundles.Add(new StyleBundle("~/css/plugins/ionRangeSlider/ionRangeStyles").Include(
            ...
            // chosen styles
            bundles.Add(new StyleBundle("~/css/plugins/chosen/chosenStyles").Include(
            ...
            // dropZone styles
            bundles.Add(new StyleBundle("~/css/plugins/dropzone/dropZoneStyles").Include(
            ...
            // color picker styles
            bundles.Add(new StyleBundle("~/css/plugins/colorpicker/colorpickerStyles").Include(
            ...
            // jsTree styles
            bundles.Add(new StyleBundle("~/css/plugins/jsTree").Include(
            ...
            bundles.Add(new StyleBundle("~/plugins/footableStyles").Include(
                      "~/css/plugins/footable/footable.core.css", new CssRewriteUrlTransform()));
            ...
            bundles.Add(new StyleBundle("~/plugins/slickStyles").Include(
                      "~/css/plugins/slick/slick.css", new CssRewriteUrlTransform()));

            // Slick carousel theme Styless
            bundles.Add(new StyleBundle("~/plugins/slickThemeStyles").Include(
                      "~/css/plugins/slick/slick-theme.css", new CssRewriteUrlTransform()));
