 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderPrint.aspx.cs"
	Inherits="RmsAuto.Store.Web.PrivateOffice.OrderPrint" %>
...
<body>
    ...
    <div class="body">
        <img runat="server" alt="" src="<%$ Resources:ImagesURL, print_logo %>" align="left" />
        <table class="tel">
            <tr>
			...
			<HeaderTemplate>
				...
				<table>
					<tr>
						...
						<th class="nowrap">
							<%=global::Resources.Texts.Price %>&nbsp;<%=global::Resources.Texts.RoubleShort %>
						</th>
						<th class="nowrap">
							<%=global::Resources.Texts.QtyLC %>
						</th>
						<th class="nowrap">
							<%=global::Resources.Texts.Summ %>&nbsp;<%=global::Resources.Texts.RoubleShort %>
						</th>
					</tr>
			</HeaderTemplate>
			<ItemTemplate>
