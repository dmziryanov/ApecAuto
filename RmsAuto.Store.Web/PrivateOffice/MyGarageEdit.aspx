<%@ Page Title="" Language="C#" MasterPageFile="~/PageTwoColumns.Master" AutoEventWireup="true" CodeBehind="MyGarageEdit.aspx.cs" Inherits="RmsAuto.Store.Web.PrivateOffice.MyGarageEdit" %>
...
<div style="margin: 14px 0 0 0" onkeypress="javascript: if(event.keyCode==13) { <%=Page.GetPostBackClientEvent(btnAddCar, String.Empty)%>; return false; }">
    <h2><%=global::Resources.Texts.Editing %></h2>
...
<br />
<asp:ImageButton ID="btnAddCar" runat="server" ImageUrl="<%$ Resources:ImagesURL, car_edit %>" OnClick="btnEditCarClick" ValidationGroup="CarEditGroup" />
